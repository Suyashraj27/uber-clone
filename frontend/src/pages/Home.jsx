...
const Home = () => {
    ...
    return (
        <div className='h-screen relative overflow-hidden'>
            ...
            <div className='fixed w-full z-10 space-y-2 bottom-0 translate-y-full bg-white px-3 py-8'>
                <h3 className = 'text-2xl font-semibold mb-5'>Choose a Vehicle</h3>
                <div className = 'flex border-2 active:border-black rounded-xl w-full p-3 items-center justify-between'>
                ...
                <div className = 'flex border-2 active:border-black rounded-xl w-full p-3 items-center justify-between'>
                    ...
                    <div className = 'ml-2 w-1/2'>
                        <h4 className='font-medium text-base' >Rickshaw <span><i className='ri-user-3-fill'></i>3</span></h4>
                        <h5 className='font-medium text-sm' >2 mins away</h5>
                        <p className = 'font-normal text-xs text-gray-600'>Affordable, compact rides</p>
                    </div>
                    <h2 className='text-lg font-semibold' >₹118.5</h2>
                </div>
            </div>
        </div>
    )
